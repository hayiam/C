...
// 1YB.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMy1YBApp, CWinApp)
...
// Единственный объект CMy1YBApp

CMy1YBApp theApp;


// Инициализация CMy1YBApp

BOOL CMy1YBApp::InitInstance()
{
